...
//check==0 : 위치 권한은 있지만 ,위치가 안켜져 있는 경우 ->키도록 권유
//check==2 : GPS, Network가 안켜져있는 경우
//check==1 : 위치는 켜져있고, 위치권한도 있는 경우
class LoadingActivity:AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var mainActivity = Intent(this@LoadingActivity, MainActivity::class.java)
